<div class="grid lg:grid-cols-12 gap-3 h-full w-full overflow-hidden">
    ...
    <div class=" hidden lg:flex lg:col-span-7 m-auto items-center w-full scrollbar-hide">
    ...
    <div class="lg:col-span-5 h-full scrollbar-hide relative flex gap-4 flex-col overflow-hidden overflow-y-scroll">


        {{-- Author --}}
        <div class="flex items-center gap-3 border-b py-2  sticky  top-0 bg-white z-10 ">
            ...
            <div class="grid grid-cols-7 w-full gap-2">
                ...
                <div class="col-span-5">
                    <h4 class="font-semibold truncate text-lg">{{ $post->user->username }} </h4>
                </div>
        ...
        {{-- Comments --}}
        <div class="overflow-hidden overflow-y-scroll scrollbar-hide">

            {{-- Big comment --}}
            @foreach ($comments as $comment)
                @include('livewire.post.view.components.comments')

                {{-- Small comment --}}
                @if ($comment->replies)
                    @foreach ($comment->replies as $reply)
                        @include('livewire.post.view.components.replies')
                    @endforeach
                @endif
            @endforeach
        ...
        {{-- footer --}}
        <div class="bottom-0 sticky mt-auto">
            {{-- Buttons --}}
